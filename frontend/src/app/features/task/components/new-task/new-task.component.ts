...
export class NewTaskComponent implements OnInit {
  ...
  onSidebarShow() {
    console.log(this.taskDeadlineControl.value);
  ...
  getFileDetails(fileName: string): { color: string, extension: string, x: string } {
