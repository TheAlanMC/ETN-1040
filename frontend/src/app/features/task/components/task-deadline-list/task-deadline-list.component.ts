...
@Component({
    selector: 'app-task-deadline-list',
    templateUrl: './task-deadline-list.component.html',
    styleUrl: './task-deadline-list.component.scss',
    providers: [MessageService, ConfirmationService,],
})
export class TaskDeadlineListComponent implements OnInit {
    ...
    constructor(
        public parent: TaskDeadlineComponent,
                ...
                if (refresh) {
                    setTimeout(() => {
                            this.router.navigateByUrl('/',
                                ...
                                this.router.navigate(['/tasks/view/task-deadline',
