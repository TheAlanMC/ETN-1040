...
BEGIN
    ...
    VALUES (NEW.loaned_tool_id, NEW.task_id, NEW.tool_id, NEW.user_id, NEW.status, CURRENT_TIMESTAMP, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
...
BEGIN
    ...
    VALUES (NEW.task_id, NEW.project_id, NEW.task_name, NEW.task_description, NEW.task_deadline, NEW.task_priority, NEW.task_status_id, NEW.status, CURRENT_TIMESTAMP, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
...
BEGIN
    ...
    VALUES (NEW.task_assignee_id, NEW.task_id, NEW.user_id, NEW.status, CURRENT_TIMESTAMP, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
...
BEGIN
    ...
    VALUES (NEW.task_comment_id, NEW.task_id, NEW.user_id, NEW.comment_number, NEW.comment, NEW.status, CURRENT_TIMESTAMP, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
...
BEGIN
    ...
    VALUES (NEW.task_comment_file_id, NEW.task_comment_id, NEW.file_id, NEW.status, CURRENT_TIMESTAMP, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
...
BEGIN
    ...
    VALUES (NEW.tool_id, NEW.file_photo_id, NEW.tool_name, NEW.tool_description, NEW.tool_code, NEW.available, NEW.status, CURRENT_TIMESTAMP, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
