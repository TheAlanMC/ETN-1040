...
BEGIN
    ...
    VALUES (NEW.h_loaned_tool_id, NEW.task_id, NEW.tool_id, NEW.user_id, NEW.status, NEW.tx_date, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
...
$$
BEGIN
    INSERT INTO h_task (h_task_id, project_project_id, task_name, task_description, task_deadline, task_priority, task_status, status, tx_date, tx_user, tx_host)
    VALUES (NEW.h_task_id, NEW.project_project_id, NEW.task_name, NEW.task_description, NEW.task_deadline, NEW.task_priority, NEW.task_status, NEW.status, NEW.tx_date, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
...
BEGIN
    ...
    VALUES (NEW.h_task_assignee_id, NEW.task_id, NEW.user_id, NEW.status, NEW.tx_date, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
...
BEGIN
    ...
    VALUES (NEW.h_task_comment_id, NEW.task_id, NEW.user_id, NEW.comment_number, NEW.comment, NEW.status, NEW.tx_date, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
...
BEGIN
    ...
    VALUES (NEW.h_task_comment_file_id, NEW.task_comment_id, NEW.file_id, NEW.status, NEW.tx_date, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
...
BEGIN
    ...
    VALUES (NEW.h_tool_id, NEW.file_photo_id, NEW.tool_name, NEW.tool_description, NEW.tool_code, NEW.available, NEW.status, NEW.tx_date, NEW.tx_user, NEW.tx_host);
    RETURN NEW;
END;
$$
LANGUAGE 'plpgsql';
